...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('rtabmap_viz',  default_value='true',  description='Launch RTAB-Map UI (optional). Disabled by default due to snap library conflicts; use RViz instead.'),
        ...
        DeclareLaunchArgument('odom_frame_id',  default_value='map',                   description='If set, TF is used to get odometry instead of the topic.'),
        ...
        DeclareLaunchArgument('scan_topic',           default_value='/lidar_scan',       description=''),
