    ...
    return [
        ...
        Node(
            ...
            arguments=[
                ...
                "--log-level",
                ["rtabmap_viz:=", LaunchConfiguration("log_level")],
            ],
            prefix=LaunchConfiguration("launch_prefix"),
            namespace=LaunchConfiguration("namespace"),
        ),
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "rtabmap_viz",
                default_value="true",
                description="Launch RTAB-Map UI (optional). Disabled by default due to snap library conflicts; use RViz instead.",
            ),
            DeclareLaunchArgument(
            ...
            # DeclareLaunchArgument('', default_value=config_rviz,               description='Configuration path of rviz2.'),
            DeclareLaunchArgument(
                "frame_id",
            ...
            DeclareLaunchArgument(
                "scan_topic", default_value="/lidar_scan", description=""
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument(
                "odom_always_process_most_recent_frame",
                default_value="true",
                description="Odometry: always process latest frame to reduce delay, skipping frames in case odometry is slower than camera frame rate. In case you want to make sure to process all frames (e.g., from a rosbag/dataset) and you don't care about delay, set this to false.",
            ),
            # imu
            DeclareLaunchArgument(
                "imu_topic",
            ...
            DeclareLaunchArgument(
                ...
                description="A rtabmap_msgs/EnvSensor topic.",
            ),
