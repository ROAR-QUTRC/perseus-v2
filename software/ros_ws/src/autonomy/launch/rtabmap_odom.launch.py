    ...
    return [
        ...
        Node(
            ...
            parameters=[
                {
                    ...
                    "always_process_most_recent_frame": LaunchConfiguration(
                        "odom_always_process_most_recent_frame"
                    ),
                    "rgbd_odometry_image_downscale": LaunchConfiguration(
                        "rgbd_odometry_image_downscale"
                    ),
                }
            ],
            remappings=[
            ...
            arguments=[
                ...
                "--Vis/MinDepth",
                LaunchConfiguration("odom_min_depth"),
                "--ros-args",
                "--log-level",
                [
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "cfg",
                default_value="",
                description="Path to odometry config file (*.ini).",
            ),
            DeclareLaunchArgument(
                "frame_id",
            ...
            DeclareLaunchArgument(
                ...
                description="Already synchronized RGB-D related topic.",
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument(
                ...
                description="Common types: compressed, theora",
            ),
            DeclareLaunchArgument(
                "depth_image_transport",
                default_value="compressedDepth",
                description="Depth compatible types: compressedDepth",
            ),
            # LiDAR
            DeclareLaunchArgument(
                "subscribe_scan",
            ...
            DeclareLaunchArgument(
                ...
                default_value="false",
                description="Subscribe to point cloud topic.",
            ),
            DeclareLaunchArgument(
                "scan_cloud_topic",
            ...
            DeclareLaunchArgument(
                "odom_args",
                default_value="",
                description="More arguments for odometry.",
            ),
            DeclareLaunchArgument(
                "odom_min_depth",
                default_value="0.2",
                description="Minimum depth in meters to use (0=disabled). Filters out closer objects.",
            ),
            DeclareLaunchArgument(
                "odom_sensor_sync",
                default_value="false",
                description="Sensor sync for odometry.",
            ),
            DeclareLaunchArgument(
                "odom_guess_frame_id",
                default_value="",
                description="Frame id for odometry guess.",
            ),
            DeclareLaunchArgument(
                "odom_guess_min_translation",
                default_value="0.0",
                description="Minimum translation for odometry guess.",
            ),
            DeclareLaunchArgument(
                "odom_guess_min_rotation",
                default_value="0.0",
                description="Minimum rotation for odometry guess.",
            ),
            DeclareLaunchArgument(
                "odom_always_process_most_recent_frame",
                default_value="true",
                description="Odometry: always process latest frame to reduce delay.",
            ),
            DeclareLaunchArgument(
                "odom_log_level",
                default_value=LaunchConfiguration("log_level"),
            ...
            DeclareLaunchArgument(
                "wait_imu_to_init",
                default_value="false",
                description="Wait for IMU to initialize.",
            ),
            DeclareLaunchArgument(
                "always_check_imu_tf",
                default_value="true",
                description="Always check if TF between IMU frame and base frame has changed.",
            ),
