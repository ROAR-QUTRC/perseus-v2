...
def generate_launch_description():
    ...
    declare_args = [
        ...
        DeclareLaunchArgument(
            "device_type", default_value="''", description="choose device by type"
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            "initial_reset", default_value="false", description="initial reset"
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value="false",
            description="Depth module hdr enablement flag",
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value="7500",
            description="Depth module first exposure value for hdr_merge",
        ),
        DeclareLaunchArgument(
            "depth_module.gain.1",
            default_value="16",
            description="Depth module first gain value for hdr_merge",
        ),
        DeclareLaunchArgument(
            "depth_module.exposure.2",
            default_value="1",
            description="Depth module second exposure value for hdr_merge",
        ),
        DeclareLaunchArgument(
            "depth_module.gain.2",
            default_value="16",
            description="Depth module second gain value for hdr_merge",
        ),
        # Sync and IMU parameters
        DeclareLaunchArgument(
            "enable_sync", default_value="false", description="enable sync mode"
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            "enable_rgbd", default_value="false", description="enable rgbd topic"
        ),
        DeclareLaunchArgument(
            "enable_gyro", default_value="false", description="enable gyro stream"
        ),
        DeclareLaunchArgument(
            "enable_accel", default_value="false", description="enable accel stream"
        ),
        ...
        DeclareLaunchArgument(
            "clip_distance", default_value="-2.", description="clip distance"
        ),
        DeclareLaunchArgument(
            "angular_velocity_cov",
            default_value="0.01",
            description="angular velocity covariance",
        ),
        DeclareLaunchArgument(
            "linear_accel_cov",
            default_value="0.01",
        ...
        DeclareLaunchArgument(
            "publish_tf",
            default_value="true",
            description="enable/disable publishing static & dynamic TF",
        ),
        DeclareLaunchArgument(
            "tf_publish_rate",
            default_value="0.0",
            description="rate in Hz for publishing dynamic TF",
        ),
        # Pointcloud parameters
        DeclareLaunchArgument(
            "pointcloud.enable", default_value="false", description="enable pointcloud"
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value="false",
            description="allow no texture points",
        ),
        # Filter parameters
        DeclareLaunchArgument(
            "align_depth.enable",
        ...
        DeclareLaunchArgument(
            ...
            default_value="false",
            description="enable disparity filter",
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value="-1.",
            description="Timeout for waiting for device to connect",
        ),
        DeclareLaunchArgument(
            "reconnect_timeout",
            default_value="6.",
            description="Timeout between consecutive reconnection attempts",
        ),
        # Frame parameters
        DeclareLaunchArgument(
            "base_frame_id",
        ...
        DeclareLaunchArgument(
            "tf_prefix",
            default_value="",
            description="prefix to be prepended to all frame IDs",
        ),
        # Safety stream parameters
        DeclareLaunchArgument(
            "enable_safety", default_value="false", description="enable safety stream"
        ),
        DeclareLaunchArgument(
            "safety_camera.safety_mode",
            default_value="0",
            description="[int] 0-Run, 1-Standby, 2-Service",
        ),
        # Labeled pointcloud parameters
        DeclareLaunchArgument(
            "enable_labeled_point_cloud",
            default_value="false",
            description="enable labeled point cloud stream",
        ),
        DeclareLaunchArgument(
            "depth_mapping_camera.labeled_point_cloud_profile",
            default_value="0,0,0",
            description="Label PointCloud stream profile",
        ),
        # Occupancy parameters
        DeclareLaunchArgument(
            "enable_occupancy",
            default_value="false",
            description="enable occupancy stream",
        ),
        DeclareLaunchArgument(
            "depth_mapping_camera.occupancy_profile",
            default_value="0,0,0",
            description="Occupancy stream profile",
        ),
