...
private:
    ...
    hi_can::parameters::post_landing::servo::rmd::RmdParameterGroup _ElbowParameterGroup(hi_can::addressing::post_landing::servo::rmd::motor_id::ELBOW);
    hi_can::parameters::post_landing::servo::rmd::RmdParameterGroup _WristRollParameterGroup(hi_can::addressing::post_landing::servo::rmd::motor_id::WRIST_ROLL);
    hi_can::parameters::post_landing::servo::rmd::RmdParameterGroup _WristYawParameterGroup(hi_can::addressing::post_landing::servo::rmd::motor_id::WRIST_YAW);
