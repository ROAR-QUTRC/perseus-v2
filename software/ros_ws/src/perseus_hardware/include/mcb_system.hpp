...
{
    class McbSystemHardware : public hardware_interface::SystemInterface
    {
    public:
    ...
    private:
        ...
        std::vector<hi_can::parameters::legacy::drive::motors::EscParameterGroup> _parameter_groups;
        std::vector<unsigned long> _esc_ids;
