...
{ lib, buildRosPackage, ament-cmake, backward-ros, nlohmann_json, openssl, rclcpp, realsense2-camera, realsense2-description, sensor-msgs, simple-networking }:
buildRosPackage rec {
  ...
  propagatedBuildInputs = [ backward-ros nlohmann_json openssl rclcpp realsense2-camera realsense2-description sensor-msgs simple-networking ];
