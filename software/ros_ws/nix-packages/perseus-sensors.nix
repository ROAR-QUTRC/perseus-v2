...
{ lib, buildRosPackage, ament-cmake, backward-ros, nlohmann_json, openssl, rclcpp, sensor-msgs, simple-networking }:
buildRosPackage rec {
  ...
  propagatedBuildInputs = [ backward-ros nlohmann_json openssl rclcpp sensor-msgs simple-networking ];
