...
{ lib, buildRosPackage, ament-cmake, ament-lint-auto, ament-lint-common, backward-ros, builtin-interfaces, geometry-msgs, rosidl-default-generators, rosidl-default-runtime }:
buildRosPackage rec {
  ...
  propagatedBuildInputs = [ backward-ros builtin-interfaces geometry-msgs rosidl-default-runtime ];
