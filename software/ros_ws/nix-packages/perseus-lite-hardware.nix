...
{ lib, buildRosPackage, ament-cmake, hardware-interface, pluginlib, rclcpp, rclcpp-lifecycle, serial }:
buildRosPackage rec {
  ...
  propagatedBuildInputs = [ hardware-interface pluginlib rclcpp rclcpp-lifecycle serial ];
