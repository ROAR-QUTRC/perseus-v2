...
{ lib, buildRosPackage, actuator-msgs, ament-cmake, backward-ros, hi-can-raw, rclcpp, sensor-msgs }:
buildRosPackage rec {
  ...
  propagatedBuildInputs = [ actuator-msgs backward-ros hi-can-raw rclcpp sensor-msgs ];
