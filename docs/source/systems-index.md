...
The [_software_ architecture](project:/systems/software-index.md) lays out how the _code_ interacts with itself and its environment, as well as which bits do what.
The [_hardware_ architecture](project:/systems/hardware-index.md) goes over how everything's _physically_ connected and laid out, as well as the electrical wiring.
