...
Abbreviated from "hierarchical CAN", Hi-CAN is the library implementing the standards laid out [here](project:./can-bus.md), and is shared across ROS and native code, as well as firmware.
