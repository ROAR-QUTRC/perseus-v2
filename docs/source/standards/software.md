...
If the code you're writing is primarily Arduino and/or FreeRTOS-based, feel, feel free to use either `camelCase` or `snake_case` - just keep whatever you do consistent internally in the project.
