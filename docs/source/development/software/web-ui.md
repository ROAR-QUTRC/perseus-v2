...
The WebSocket connection is managed inside the file: `src/lib/scripts/rosBridge.svelte.ts`. The exports of this file are the functions: `getRosConnection`, `connectRos` and `disconnectRos`.
