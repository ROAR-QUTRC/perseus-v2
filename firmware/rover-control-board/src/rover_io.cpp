...
void initialize_uart(uart_port_t uart, int baudRate, int pinTx, int pinRx)
{
    ...
    printf("Initialised uart %d to %d baud", (int)uart, baudRate);
}
...
void initialize_nvs()
{
    ...
    {
        printf("NVS init failed! Erasing...");
