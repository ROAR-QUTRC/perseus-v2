...
void I2CSlave::init()
{
    ...
    i2c0->hw->enable = 1;
    i2c0->hw->intr_mask = I2C_IC_INTR_MASK_M_RX_FULL_BITS | I2C_IC_INTR_MASK_M_RD_REQ_BITS | I2C_IC_INTR_MASK_M_TX_ABRT_BITS | I2C_IC_INTR_MASK_M_STOP_DET_BITS;
...
{
    return static_cast<int8_t>(live_regs_[kibisis::kRegMotorASpeed]);
}

int8_t I2CSlave::getMotorBSpeed() const
{
    return static_cast<int8_t>(live_regs_[kibisis::kRegMotorBSpeed]);
}

int8_t I2CSlave::getSpaceMotorSpeed() const
{
    return static_cast<int8_t>(live_regs_[kibisis::kRegSpaceMotorSpeed]);
}
