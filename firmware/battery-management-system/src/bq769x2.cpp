...
bq76942::da_status_5_t bq76942::get_DA_status_5()
{
    ...
    const da_configuration_t da_config = settings.configuration.getDAConfiguration();
    return da_status_5_t{
        .vreg18AdcCounts = raw_status.vreg18AdcCounts,
        ...
        .cc3Current = static_cast<float>(raw_status.cc3Current) * get_user_amps_multiplier(da_config),
        .cc1Current = static_cast<float>(raw_status.cc1Current) * get_user_amps_multiplier(da_config),
        .cc2Counts = raw_status.cc2Counts,
        .cc3Counts = raw_status.cc3Counts,
    };
}
...
bq76942::da_status_6_t bq76942::get_DA_status_6()
{
    ...
    return da_status_6_t{
        ...
        .ts1Counts = raw_status.ts1Counts,
        .ts2Counts = raw_status.ts2Counts,
    };
}
...
{
    return read_direct<int16_t>(direct_command::STACK_VOLTAGE) * get_user_volts_multiplier(settings.configuration.getDAConfiguration());
}

int32_t bq76942::get_pack_voltage()
{
    return read_direct<int16_t>(direct_command::PACK_PIN_VOLTAGE) * get_user_volts_multiplier(settings.configuration.getDAConfiguration());
}

int32_t bq76942::get_ld_voltage()
{
    return read_direct<int16_t>(direct_command::LD_PIN_VOLTAGE) * get_user_volts_multiplier(settings.configuration.getDAConfiguration());
}

float bq76942::getCC2Current()
{
    return read_direct<int16_t>(direct_command::CC2_CURRENT) * get_user_amps_multiplier(settings.configuration.getDAConfiguration());
}
...
{
    return _parent.read_subcommand<int16_t>(data_register::DSG_CURRENT_THRESHOLD) * get_user_amps_multiplier(configuration.getDAConfiguration());
}

void bq76942::Settings::set_dsg_current_threshold(const uint32_t& threshold) const
{
    const int16_t rounded_threshold = static_cast<int16_t>(std::round(threshold / _parent.get_user_amps_multiplier(_parent.settings.configuration.getDAConfiguration())));
...
{
    return _parent.read_subcommand<int16_t>(data_register::CHG_CURRENT_THRESHOLD) * get_user_amps_multiplier(configuration.getDAConfiguration());
}
...
{
    return _parent.read_subcommand<int16_t>(data_register::OCD3_THRESHOLD) * get_user_amps_multiplier(_parent.settings.configuration.getDAConfiguration());
}
...
{
    return _parent.read_subcommand<int16_t>(data_register::PTO_RESET) * get_user_amps_multiplier(_parent.settings.configuration.getDAConfiguration());
}

void bq76942::Protections::set_precharge_reset_charge(const float& charge) const
{
    const int16_t rounded_charge = static_cast<int16_t>(std::round(charge / _parent.get_user_amps_multiplier(_parent.settings.configuration.getDAConfiguration())));
...
{
    const da_configuration_t da_config = _parent.settings.configuration.getDAConfiguration();
