...
void print_bms_status(bq76942& bq)
{
    ...
    // print alarm regs
    auto alarmAStatus = bq.get_safety_status_a();
    auto alarmBStatus = bq.get_safety_status_b();
    auto alarmCStatus = bq.get_safety_status_c();
    ...
    auto pfAStatus = bq.get_permanent_fail_status_a();
    auto pfBStatus = bq.get_permanent_fail_status_b();
    auto pfCStatus = bq.get_permanent_fail_status_c();
    auto pfDStatus = bq.get_permanent_fail_status_d();
