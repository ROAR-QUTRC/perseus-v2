    ...
    struct cfetoff_pin_configuration_t
    {
        union
        {
            struct
            {
                ...
                bool disable_highZDrive : 1;  // OPT[1]
...
#pragma pack(pop)
    ...
    void setGPO(const gpo_state& state) { write_subcommand(static_cast<cmd_only_subcommand>(state)); }
    ...
    uint16_t getIROMSignature() { return read_subcommand<uint16_t>(subcommand::IROM_SIG); };
    ...
    uint16_t getDROMSignature() { return read_subcommand<uint16_t>(subcommand::DROM_SIG); };
    security_keys_t get_security_keys();
    void set_security_keys(const security_keys_t& keys);
    saved_pf_status_t get_savedPFStatus() { return read_subcommand<saved_pf_status_t>(subcommand::SAVED_PF_STATUS); };
    ...
    public:
        ...
        int16_t getVDividerOffset() const { return _parent.read_subcommand<int16_t>(data_register::VDIV_OFFSET); }
        void setVDividerOffset(const int16_t& offset) const { _parent.write_subcommand(data_register::VDIV_OFFSET, offset); }
        ...
        class Temperature final
        {
            ...
            int8_t get_ts1Offset() const { return _parent.read_subcommand<int8_t>(data_register::TS1_TEMP_OFFSET); }
            void set_ts1Offset(const int8_t& offset) const { _parent.write_subcommand(data_register::TS1_TEMP_OFFSET, offset); }
            int8_t get_ts2Offset() const { return _parent.read_subcommand<int8_t>(data_register::TS2_TEMP_OFFSET); }
            void set_ts2Offset(const int8_t& offset) const { _parent.write_subcommand(data_register::TS2_TEMP_OFFSET, offset); }
            int8_t get_ts3Offset() const { return _parent.read_subcommand<int8_t>(data_register::TS3_TEMP_OFFSET); }
            void set_ts3Offset(const int8_t& offset) const { _parent.write_subcommand(data_register::TS3_TEMP_OFFSET, offset); }
    ...
    public:
        ...
        public:
            ...
            regulator_control_t get_reg12Config() const { return _parent.read_subcommand<regulator_control_t>(data_register::REG12_CONFIG); }
            void set_reg12Config(const regulator_control_t& config) const { _parent.write_subcommand(data_register::REG12_CONFIG, config); }
            reg0_config_t get_reg0Config() const { return _parent.read_subcommand<reg0_config_t>(data_register::REG0_CONFIG); }
            ...
            da_configuration_t getDAConfiguration() const { return _parent.read_subcommand<da_configuration_t>(data_register::DA_CONFIGURATION); }
            void setDAConfiguration(const da_configuration_t& config) const { _parent.write_subcommand(data_register::DA_CONFIGURATION, config); }
            ...
            uint8_t getCC3Samples() const { return _parent.read_subcommand<uint8_t>(data_register::CC3_SAMPLES); }
            void setCC3Samples(const uint8_t& samples) const { _parent.write_subcommand(data_register::CC3_SAMPLES, samples); }
    ...
    public:
        ...
        std::chrono::seconds read2LvlDelay() const { return std::chrono::seconds(_parent.read_subcommand<uint8_t>(data_register::PF_2LVL_DELAY)); }
        void set2LvlDelay(const std::chrono::seconds& delay) const { _parent.write_subcommand(data_register::PF_2LVL_DELAY, static_cast<uint8_t>(delay.count())); }
